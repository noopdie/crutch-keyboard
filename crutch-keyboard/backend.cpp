...
void BackEnd::prepare()
{
    ...
    QStringList args2 = {"/crutch-keyboard-files/vkb-event.sh"};
...
QString BackEnd::readevent()
{
    ...
    QStringList args2 = {"/crutch-keyboard-files/vkb-event"};
    QTextStream cout(stdout);
  //  cout << args[1];
...
void BackEnd::close(const QString &closed)
{
    QProcess OProcess;
    QString Command = "/bin/cat";
    QStringList args = {"/crutch-keyboard-files/vkb-event-pid"};
    QTextStream cout(stdout);
  //  cout << args[1];
